...
/// @brief              Develop a CAN tunnel
/// @param pdcan_name   Name of device, in the project we employ a "GC_USBCAN"
/// @param dev_type     Device type
/// @param dev_index    Index of device, Starting from 0
/// @param can_index    Index of CAN tunnel on the device, starting from 0
...
{
public:
/// @brief              Establishing a CAN connection, here expected to connects a DJI R Gimbal
/// @param send_id      CAN Tx value (PC side)
/// @param recv_id      CAN Rx value (PC side)
/// @param can_name     Name of the USB CAN device
/// @param tunnel_type  Device type, defiend in USBCANSDK::TunnelType
/// @param tunnel_id    Index of USB CAN device, starting from 0
/// @param can_index    Index of CAN tunnel on the device, starting from 0
    CANConnection(
            int                     send_id, 
            int                     recv_id, 
            std::string             can_name    = "GC_USBCAN",
